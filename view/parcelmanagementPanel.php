        ...
        <table border="1" cellspacing="0" width="100%" cellpadding="10" height="400px">
            ...
            <tr>
                ...
                <tr>
                    ...
                    <td>
                        <a href="../view/AdminPanel/editParcelStatus.php?IdParcel=<?php echo $users[$i]['parcelID'] ?>" name ="edit"  style="color: Green; font-size:22px;"><i class="fa-solid fa-pen-to-square"></i></a>
                    </td>
                    <td>
